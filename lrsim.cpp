...
int main(int argc, const char* argv[])
{
    ...
    OH.addOpt(0, "rvariance", 1, "Number", "Read error rate float variance.",'F',&(ReadFloatVariance));
    OH.addOpt(0, "bfvariance", 1, "Number", "Read block error rate float variance.",'F',&(BlockFloatVariance));
