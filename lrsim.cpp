...
int main(int argc, const char* argv[])
{
    ...
    OH.addOpt(0, "rvarianceratio", 1, "Number", "Multiplies errorrate to form read error rate float variance.",'F',&(ReadFloatVariance));
    OH.addOpt(0, "bfvarianceratio", 1, "Number", "Multiplies errorrate to form read block error rate float variance.",'F',&(BlockFloatVariance));
